        ...
        <div class="landingWrapper sm:w-full sm:flex">
            <div class="landingL sm:flex-none sm:w-1/2">
                ...
                <div class="flex justify-center pt-10 sm:pt-24 sm:block ">
                    <a href="/documents/Chukwuma-Okere-Resume.docx" @click="downloadCV" class="flex place-self-center sm:float-left px-4 py-3 sm:flex sm:px-5 sm:py-4 hover:shadow-lg shadow-md rounded transition ease-in duration-200 focus:outline-none hover:text-white text-white text-xl bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
