<template>
   <div class="flex relative w-full" id="nav">
    <button @click="openEmailModal" class="flex rounded transition ease-in duration-200 focus:outline-none px-3 hover:text-black text-blue-500">
